...
#FS (Three rules)
bfrt.RF.pipe.Ingress.table_T1_FS.add_with_classify_T1(metadata_frame_size_start=data['Tree1']['FS']['r1']['min'], 
                                                      metadata_frame_size_end=data['Tree1']['FS']['r1']['max'], 
                                                      classify_result=data['Tree1']['FS']['r1']['class'])

bfrt.RF.pipe.Ingress.table_T1_FS.add_with_classify_T1(metadata_frame_size_start=data['Tree1']['FS']['r2']['min'], 
                                                      metadata_frame_size_end=data['Tree1']['FS']['r2']['max'], 
                                                      classify_result=data['Tree1']['FS']['r2']['class'])


bfrt.RF.pipe.Ingress.table_T1_FS.add_with_classify_T1(metadata_frame_size_start=data['Tree1']['FS']['r3']['min'], 
...
'''
#IPG (Two Rules)
bfrt.RF.pipe.Ingress.table_T1_IPG.add_with_classify_T1(metadata_ipg_20lsb_start=data['Tree1']['IPG']['r1']['min'], 
                                                      metadata_ipg_20lsb_end=data['Tree1']['IPG']['r1']['max'], 
                                                      classify_result=data['Tree1']['IPG']['r1']['class'])

bfrt.RF.pipe.Ingress.table_T1_IPG.add_with_classify_T1(metadata_ipg_20lsb_start=data['Tree1']['IPG']['r2']['min'], 
...
'''
#IFG (Two Rules)
bfrt.RF.pipe.Ingress.table_T2_IFG.add_with_classify_T2(metadata_ifg_20lsb_start=data['Tree2']['IFG']['r1']['min'], 
                                                       metadata_ifg_20lsb_end=data['Tree2']['IFG']['r1']['max'], 
                                                       classify_result=data['Tree2']['IFG']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T2_IFG.add_with_classify_T2(metadata_ifg_20lsb_start=data['Tree2']['IFG']['r2']['min'], 
...
#IPG (Two Rules)
bfrt.RF.pipe.Ingress.table_T2_IPG.add_with_classify_T2(metadata_ipg_20lsb_start=data['Tree2']['IPG']['r1']['min'], 
                                                       metadata_ipg_20lsb_end=data['Tree2']['IPG']['r1']['max'], 
                                                       classify_result=data['Tree2']['IPG']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T2_IPG.add_with_classify_T2(metadata_ipg_20lsb_start=data['Tree2']['IPG']['r2']['min'], 
...
'''
#FS (Two Rules)
bfrt.RF.pipe.Ingress.table_T3_FS.add_with_classify_T3(metadata_frame_size_start=data['Tree3']['FS']['r1']['min'], 
                                                      metadata_frame_size_end=data['Tree3']['FS']['r1']['max'], 
                                                      classify_result=data['Tree3']['FS']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T3_FS.add_with_classify_T3(metadata_frame_size_start=data['Tree3']['FS']['r2']['min'], 
...
'''
#IFG (Two Rules)
bfrt.RF.pipe.Ingress.table_T3_IFG.add_with_classify_T3(metadata_ifg_20lsb_start=data['Tree3']['IFG']['r1']['min'], 
                                                       metadata_ifg_20lsb_end=data['Tree3']['IFG']['r1']['max'], 
                                                       classify_result=data['Tree3']['IFG']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T3_IFG.add_with_classify_T3(metadata_ifg_20lsb_start=data['Tree3']['IFG']['r2']['min'], 
...
#IPG (Two Rules)
bfrt.RF.pipe.Ingress.table_T3_IPG.add_with_classify_T3(metadata_ipg_20lsb_start=data['Tree3']['IPG']['r1']['min'], 
                                                       metadata_ipg_20lsb_end=data['Tree3']['IPG']['r1']['max'], 
                                                       classify_result=data['Tree3']['IPG']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T3_IPG.add_with_classify_T3(metadata_ipg_20lsb_start=data['Tree3']['IPG']['r2']['min'], 
...
'''
#IFG (Two Rule)
bfrt.RF.pipe.Ingress.table_T4_IFG.add_with_classify_T4(metadata_ifg_20lsb_start=data['Tree4']['IFG']['r1']['min'], 
                                                       metadata_ifg_20lsb_end=data['Tree4']['IFG']['r1']['max'], 
                                                       classify_result=data['Tree4']['IFG']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T4_IFG.add_with_classify_T4(metadata_ifg_20lsb_start=data['Tree4']['IFG']['r2']['min'], 
...
#FS (Two Rules)
bfrt.RF.pipe.Ingress.table_T4_FS.add_with_classify_T4(metadata_frame_size_start=data['Tree4']['FS']['r1']['min'], 
                                                      metadata_frame_size_end=data['Tree4']['FS']['r1']['max'], 
                                                      classify_result=data['Tree4']['FS']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T4_FS.add_with_classify_T4(metadata_frame_size_start=data['Tree4']['FS']['r2']['min'], 
...
#IPG (Three Rules)
bfrt.RF.pipe.Ingress.table_T4_IPG.add_with_classify_T4(metadata_ipg_20lsb_start=data['Tree4']['IPG']['r1']['min'], 
                                                       metadata_ipg_20lsb_end=data['Tree4']['IPG']['r1']['max'], 
                                                       classify_result=data['Tree4']['IPG']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T4_IPG.add_with_classify_T4(metadata_ipg_20lsb_start=data['Tree4']['IPG']['r2']['min'], 
                                                       metadata_ipg_20lsb_end=data['Tree4']['IPG']['r2']['max'], 
                                                       classify_result=data['Tree4']['IPG']['r2']['class'])
bfrt.RF.pipe.Ingress.table_T4_IPG.add_with_classify_T4(metadata_ipg_20lsb_start=data['Tree4']['IPG']['r3']['min'], 
...
bfrt.RF.pipe.Ingress.table_T4_IPG.add_with_classify_T4(metadata_ipg_20lsb_start=1404, metadata_ipg_20lsb_end=218208, classify_result=2)
...
'''
#FS (Two Rules)
bfrt.RF.pipe.Ingress.table_T5_FS.add_with_classify_T5(metadata_frame_size_start=data['Tree5']['FS']['r1']['min'], 
                                                      metadata_frame_size_end=data['Tree5']['FS']['r1']['max'], 
                                                      classify_result=data['Tree5']['FS']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T5_FS.add_with_classify_T5(metadata_frame_size_start=data['Tree5']['FS']['r2']['min'], 
...
'''
#IPG (Two Rules)
bfrt.RF.pipe.Ingress.table_T5_IPG.add_with_classify_T5(metadata_ipg_20lsb_start=data['Tree5']['IPG']['r1']['min'], 
                                                       metadata_ipg_20lsb_end=data['Tree5']['IPG']['r1']['max'], 
                                                       classify_result=data['Tree5']['IPG']['r1']['class'])
bfrt.RF.pipe.Ingress.table_T5_IPG.add_with_classify_T5(metadata_ipg_20lsb_start=data['Tree5']['IPG']['r2']['min'], 
...
#bfrt.RF.pipe.Egress.table_pkt_check.add_with_decisionMirror(packet_counter_value_start=0, packet_counter_value_end=20)
#bfrt.RF.pipe.Egress.table_frame_check.add_with_decisionMirror(frame_counter_value_start=0,frame_counter_value_end=5)
...
with open("/home/alireza/myproject/myp4/majority1.txt", "r") as f:
    for line in f:
        line = line.strip()
        if not line:
