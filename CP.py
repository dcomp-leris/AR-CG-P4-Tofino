...
#Threshold of Mirroring 
#bfrt.RF.pipe.Egress.table_threshold.add_with_decisionMirror(packet_counter_value_start=0, packet_counter_value_end=0,frame_counter_value_start=0,frame_counter_value_end=0)
bfrt.RF.pipe.Egress.table_pkt_check.add_with_decisionMirror(packet_counter_value_start=0, packet_counter_value_end=0)
bfrt.RF.pipe.Egress.table_frame_check.add_with_decisionMirror(frame_counter_value_start=0,frame_counter_value_end=0)
